...
import { MoveBranchesForm } from './MoveBranchesForm';
import { toast } from 'sonner';

const MODAL_TYPE = 'MOVE_BRANCHES_ASSIGNED';

interface UnassignModalProps {
  /** Branch IDs from the Assigned column that are currently selected */
  selectedBranchIds: string[];
}

/**
 * Modal used in AssignedBranchList.
 * Moves selected assigned branches from their current territory to a new one.
 * Builds and logs the API payload, then dispatches to Redux.
 */
