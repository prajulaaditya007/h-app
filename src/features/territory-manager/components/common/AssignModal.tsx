...
interface AssignModalProps {
  /** Branch IDs from the Unassigned column that are currently selected */
  selectedBranchIds: string[];
}

/**
 * Modal used in UnassignedBranchList.
 * Assigns selected unassigned branches to a chosen territory node.
